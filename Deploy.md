...
This tutorial is **part two of a two-part tutorial series**. In the [previous tutorial](Train.md), you trained machine learning models and then registered a model in your workspace on the cloud.  
...
To run the notebook, first complete the model training in [Tutorial (part 1): Train an image classification model with Azure Machine Learning service](Train.md).   Then run the  **tutorials/img-classification-part2-deploy.ipynb** notebook using the same notebook server.
...
![Chart showing confusion matrix](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/master/articles/machine-learning/service/media/tutorial-deploy-models-with-aml/confusion.png)
...
![Graphic showing results](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/master/articles/machine-learning/service/media/tutorial-deploy-models-with-aml/results.png)
